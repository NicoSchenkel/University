function currentRobotJConfig = drawTrajectoryGripper(trajTimes, rq, robot, currentRobotJConfig, endEffector, axAnim, toolOffset)
...
for i=1:length(trajTimes)
    ...
    % Determining Pose 
        poseNow = getTransform(robot, currentRobotJConfig, endEffector) * toolOffset;  % ← toolOffset
